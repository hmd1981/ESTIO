...
export const homeHeroAr = {
  headline:
    "مرئيات وفيديو وأصول علامة تجارية جاهزة للحملات — بلا أعباء الإنتاج التقليدي.",
  subheadline:
    "توقّف عن الانتظار أسابيع. استوديو إستيو ينتج صوراً وفيديو وأنظمة بصرية متوافقة مع هويتكم — محددة النطاق ومراجَعة وجاهزة للاستخدام.",
  primaryCta: { label: "حدّد نطاق مشروعك", href: "/contact" },
  secondaryCta: { label: "شاهد ما ننتجه", href: "/ai-studio" },
} as const;
...
export const trustSectionIntroAr = {
  title: "معايير تشغيل — لا وعود تسويقية",
  description:
    "تعاقد محدود النطاق، وقرارات موثّقة، ومخرجات تصمد أمام مراجعة الإدارة وتقنية المعلومات والجهات الرقابية — لا أسلوب وكالة عامة.",
} as const;
...
export const enterpriseHighlightAr = {
  headline: "أنظمة تشغيل — لا عروض مورّدين",
  body: "الموقع والمنصّة طبقة ظاهرة. تحتها ننفّذ أتمتة حتمية على جرد تكامل متفق عليه، وخدمات استرجاع مربوطة بمصادر تعتمدونها ضمن سياسة وصول وهوية، وأدوات يشغّلها فريقكم بعد التسليم. بلا تسمية للأنظمة في النطاق لا معنى لهذا القسم.",
  bullets: [
    {
      title: "استرجاع محكوم",
  ...
  cta: { label: "بدء التأهيل", href: "/enterprise#enterprise-deal-entry" },
} as const;
...
export const finalCtaAr = {
  headline: "حدّدوا النطاق، ثم ادخلوا التأهيل",
  body: "اذكروا المخرج المطلوب، والأنظمة المشمولة، وفئات البيانات، والموقّع الداخلي على الوصول والإطلاق. نرد كتابياً بتقييم ملاءمة، أو أسئلة نطاق محددة، أو رفض مباشر — بلا ردود آلية.",
