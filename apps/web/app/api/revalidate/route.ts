...
function pathSpecsFromTag(tag: string): PathSpec[] {
  ...
  if (publicSite) {
    ...
    return [
      ...
      { path: `/${locale}/services/web-design-development` },
      { path: `/${locale}/services/content-campaigns` },
      { path: `/${locale}/services/ai-creative` },
      { path: `/${locale}/work` },
      { path: `/${locale}/resources` },
      { path: `/${locale}/enterprise` },
      { path: `/${locale}/enterprise/private-ai` },
      { path: `/${locale}/enterprise/automation` },
      { path: `/${locale}/faq` },
