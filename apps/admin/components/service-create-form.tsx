...
const PRESETS = {
  ...
  enterprise: {
    ...
    shortDescription:
      "Governed assistants, integrations, and workflow automation designed for real operating environments.",
    longDescription:
    ...
    <form onSubmit={create} className="max-w-3xl space-y-4">
      <div className="rounded-lg border border-[var(--admin-border)] bg-[var(--admin-panel)] p-4">
        ...
        <p className="mt-2 text-xs text-[var(--admin-muted)]">
          ...
          row per live route and keep sub-capabilities inside{" "}
          <code className="font-mono text-[0.7rem]">detailBlocks</code>.
        </p>
      </div>
      ...
      <label className="block">
        ...
        <p className="mt-1 text-xs text-[var(--admin-muted)]">
          ...
          <code>deliverables</code>, <code>process</code>, and <code>cta</code>.
        </p>
        <textarea
